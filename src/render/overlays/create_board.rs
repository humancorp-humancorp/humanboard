...
use crate::constants::MODAL_WIDTH_SM;
...
use super::modal_base::{modal_intercept_backdrop_clicks_stateful, render_modal_backdrop};
...
pub fn render_create_board_modal(
    ...
    // Build modal content first, before creating listeners that borrow cx
    let modal_content = modal_intercept_backdrop_clicks_stateful(
        v_flex()
        ...
        |this, _, _, _| {
            this.create_board_backdrop_reset();
        },
    ...
    render_modal_backdrop(
        "create-board-backdrop",
        opacity,
        cx,
        // Backdrop mouse down: set flag
        |this, _, _, cx| {
            this.create_board_backdrop_mouse_down(cx);
        },
        // Backdrop mouse up: close if flag is set
        |this, _, window, cx| {
            this.create_board_backdrop_mouse_up(window, cx);
        },
        modal_content
        .w(px(MODAL_WIDTH_SM))
                                        ...
                                        .child(
                                            v_flex()
                                                ...
                                                .child(
                                                    div()
                                                        .text_size(px(13.0))
                                                        .font_weight(if is_default_selected {
                                                            FontWeight::MEDIUM
                                                        } else {
                                                            FontWeight::NORMAL
                                                        })
                                    ...
                                    h_flex()
                                        ...
                                        .child(
                                            Icon::new(IconName::Globe)
                                                .size(px(20.0))
                                                .text_color(if is_icloud_selected {
                                                    primary
                                                } else {
                                                    muted_fg
                                                }),
                                        ...
                                        .child(
                                            v_flex()
                                                ...
                                                .child(
                                                    div()
                                                        .text_size(px(13.0))
                                                        .font_weight(if is_icloud_selected {
                                                            FontWeight::MEDIUM
                                                        } else {
                                                            FontWeight::NORMAL
                                                        })
